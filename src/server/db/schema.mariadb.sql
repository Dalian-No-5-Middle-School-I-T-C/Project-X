...
CREATE INDEX idx_answer_cards_updated_at ON answer_cards(updated_at);
...
CREATE INDEX idx_objective_recognitions_expires ON objective_recognitions(expires_at);
...
CREATE INDEX idx_twain_sessions_card ON twain_scan_sessions(card_id);
CREATE INDEX idx_twain_records_session ON twain_scan_records(session_id);
CREATE INDEX idx_twain_records_card ON twain_scan_records(card_id);
CREATE INDEX idx_twain_records_student ON twain_scan_records(student_id);
CREATE INDEX idx_twain_recognition_scan ON twain_recognition_results(scan_record_id);
CREATE INDEX idx_twain_sgr_session ON twain_student_grading_results(session_id);
CREATE INDEX idx_twain_sgr_student ON twain_student_grading_results(student_id);
